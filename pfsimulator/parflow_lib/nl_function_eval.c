              ...
              switch (fdir[2])
              {
                case 1:
                  ...
                  if (upwind == 0) {
                    ...
                    //printf("Main i=%d j=%d k=%d Sf_x=%f Sf_y=%f SF_mag=%f qx=%f qy=%f \n",i,j,k, Sf_x, Sf_y, Sf_mag, qx_[io], qy_[io]);
                    ...
                    if (mann_dat[io-1] == 0.0) {
                        ...
                        // if slope points out calculate flow for i-1
                        if (Sf_x > 0.0) {
